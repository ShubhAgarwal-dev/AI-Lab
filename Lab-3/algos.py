...
def get_legal_label(num, child1, child2, part:int, part2:int):
    ...
    if opp_num in child1:
        get_legal_label(opp_num, child1, child2, part, part2)
    else :
        return opp_num
...
class GeneticAlgorithm():
    ...
    def partial_crossover(self, tour1, tour2):
        ...
        child2[partition:self.cities-partition] = tour1[partition:self.cities-partition]
        child1[partition:self.cities-partition] = tour2[partition:self.cities-partition]
        child1[:partition] = tour1[:partition]; child1[self.cities-partition:] = tour1[self.cities-partition:]
